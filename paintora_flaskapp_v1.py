...
from paintora_bokehapp_v1 import bokeh_cdn_resources
from config import (
    FLASK_PORT,
    FLASK_PATH,
    FLASK_URL,
...
def index():
    ...
    return render_template("about_paintora_with_Github.html", script=script, resources=resources) #, template="Flask")
